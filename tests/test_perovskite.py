...
class TestPerovskiteStructure(unittest.TestCase):
    def test_perovskite_structure(self):
        qe_reader = PWscfInputReader("SMBA2PbI4_150.000_150.000.relax.in")
        qe_reader.read_file()
        comparison_file_writer = CIFFileWriter("comparison_structure.cif", qe_reader.structure)
        ...
        cif_writer = CIFFileWriter("gen_structure.cif", pv_structure)
